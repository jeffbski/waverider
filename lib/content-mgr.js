...
util.inherits(RedisStream, ReadableStream);

function RedisStream(key, options) {
 ...
 */
RedisStream.prototype.setKey = function (key) {
  var self = this;
  this.redisKey = key;
...
RedisStream.prototype._redisRead = function (n, cb) {
  var self = this;
  n = n || 64 * 1024;
...
RedisStream.prototype._read = function (n, cb) {
